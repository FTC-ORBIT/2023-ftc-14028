...
//    PID
    public static double elevatorKp = 0.0005;
...
//    elevator floors
    ...
    public static final int level4Pos = 2900;//TODO: config
    public static final int level2DownPos = 1100;
    public static final int level3DownPos = 1850;
    public static final int level4DownPos = 2750;
