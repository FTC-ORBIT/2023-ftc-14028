...
//    elevator floors
    ...
    public static final int level4Pos = 2840;
    public static final int level2DownPos = 900;
    public static final int level3DownPos = 1550;
    public static final int level4DownPos = 2500;
